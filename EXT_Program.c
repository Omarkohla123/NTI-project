...
void __vector_1 () __attribute__ ((interrupt));        //  __attribute__ ((signal))    makes it prioritize nested interrupts 0, 1, 2 
void __vector_1 ()
{
...
void __vector_2 () __attribute__ ((interrupt));
void __vector_2 ()
{
	ptr_ArrCallBack[1]();
...
void __vector_3 () __attribute__ ((interrupt));
void __vector_3 ()
{
	ptr_ArrCallBack[2]();
