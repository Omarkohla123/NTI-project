...
void Lcd_Goto_Row_Column(u8 row, u8 col)
{
	...
	{
		case 0:
		/* Row 0 starts at DDRAM address 0x00. Command: 0x80 + 0x00 */
		...
		case 2:
		/* Row 2 starts at DDRAM address 0x14. Command: 0x80 + 0x14 = 0x94 */
		Lcd_SendCmd(0x94 + col);
		break;
		
		case 3:
		/* Row 3 starts at DDRAM address 0x54. Command: 0x80 + 0x54 = 0xD4 */
